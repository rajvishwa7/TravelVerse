...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="margin-top: 6%" style="background: skyblue">
        <div class="row">
            <div class="col-lg-12">
                <asp:Image ID="imgBus" ImageAlign="AbsMiddle" ImageUrl="~/img/travelverse-banner.jpg" Style="width: 100%" runat="server" />
            </div>
            <div class="col-lg-12" style="margin-top: 2%">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class=" panel-title">
                            <h3>Introduction About TravelVerse</h3>
                        </div>
                    </div>
                    <div class="panel-body">
                        <p style="font-size: large">
                            TravelVerse System is Web Based application,That works with in centralised network,It Provides facility to 
            ...
            <div class="col-lg-12" style="margin-top: 2%">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class=" panel-title">
                            <h3>Why TravelVerse is Important?</h3>
                        </div>
                    </div>
                    <div class="panel-body" style="font-size: large">
                        <ul>
                            ...
                            <li>100 % Secure to book your bus tickets with TravelVerse System.
                            </li>
